...
<head>
    ...
    <link href="<?= site_url('js-vendor/fontawesome-free/css/all.min.css') ?>" rel="stylesheet" type="text/css">
    <link href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">
    <link href="<?= site_url('css/sb-admin-2.min.css') ?>" rel="stylesheet">
    <link href="<?= site_url('js-vendor/datatables/dataTables.bootstrap4.min.css') ?>" rel="stylesheet">
    <style>
...
<body id="page-top">
    ...
    <script src="<?= site_url('js-vendor/jquery/jquery.min.js') ?>"></script>
    <script src="<?= site_url('js-vendor/bootstrap/js/bootstrap.bundle.min.js') ?>"></script>
    <script src="<?= site_url('js-vendor/jquery-easing/jquery.easing.min.js') ?>"></script>
    <script src="<?= site_url('js-vendor/datatables/jquery.dataTables.min.js') ?>"></script>
    <script src="<?= site_url('js-vendor/datatables/dataTables.bootstrap4.min.js') ?>"></script>
